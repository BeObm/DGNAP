...
class MyTrainDataset(Dataset):
    def __init__(self, size):
        self.size = size
        self.data = [(torch.rand(20000), torch.rand(1)) for _ in range(size)]
...
def load_train_objs():
    train_set = MyTrainDataset(500000)  # load your dataset
    model = torch.nn.Linear(20000, 1)  # load your model
