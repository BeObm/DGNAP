...
class Bernstein(MessagePassing):
    def __init__(self, in_channels,out_channels, K, bias=False, normalization=False,aggr="add", **kwargs):
        kwargs.setdefault('aggr', aggr)
        super(Bernstein, self).__init__(**kwargs)
        assert K > 0
        self.K = K
    ...
    def forward(self, x, edge_index, edge_weight: OptTensor = None,
        ...
        bern_coeff =  Bernstein.get_bern_coeff(self.K)
        eps = 1e-2
