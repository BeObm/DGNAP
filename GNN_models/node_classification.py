...
class GNN_Model(MessagePassing):
    ...
    def get_forward_conv(self, num_layer, conv, x, edge_index, edge_attr):
        # meme si le dataset possede le edge attribute, il faut verifier si la convolution l utilise sinon cela ne
        # sera pas utiliser pour une telle convolution
...
def test_function(model, data, type_data="val"):
    ...
    performance_scores = evaluate_model(data.y[mask], pred[mask],type_data)
